...
echo Define DOCUMENT_ROOT "${DOCUMENT_ROOT}" | sudo tee    "${test_vars_path}"
echo Define LOGS_ROOT     "${LOGS_ROOT}"     | sudo tee -a "${test_vars_path}"
echo Define SERVER_NAME   "${SERVER_NAME}"   | sudo tee -a "${test_vars_path}"
echo Define SERVER_ALIAS  "${SERVER_ALIAS}"  | sudo tee -a "${test_vars_path}"
